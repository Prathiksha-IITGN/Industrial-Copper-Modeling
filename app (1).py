...
Original file is located at
    https://colab.research.google.com/drive/1SOLIYP5WIAcQ1zks_k6HOGXzjkuF4yEE
"""
...
with tab1:    
        ...
        with st.form("my_form"):
            ...
            with col3:               
                st.write( f'<h5 style="color:rgb(159, 43, 104,0.4);">NOTE: Min & Max given for reference, you can enter any value</h5>', unsafe_allow_html=True )
        ...
        if submit_button and flag==0:
            ...
            import pickle
            with open("C:/09-06-2023/model.pkl", 'rb') as file:
                loaded_model = pickle.load(file)
            with open('C:/09-06-2023/scaler.pkl', 'rb') as f:
                scaler_loaded = pickle.load(f)

            with open("C:/09-06-2023/t.pkl", 'rb') as f:
                t_loaded = pickle.load(f)

            with open("C:/09-06-2023/s.pkl", 'rb') as f:
...
with tab2: 
        ...
        if csubmit_button and cflag==0:
            import pickle
            with open("C:/09-06-2023/cmodel.pkl", 'rb') as file:
                cloaded_model = pickle.load(file)

            with open('C:/09-06-2023/cscaler.pkl', 'rb') as f:
                cscaler_loaded = pickle.load(f)

            with open("C:/09-06-2023/ct.pkl", 'rb') as f:
            ...
            if new_pred==1:
                st.write('## :purple[The Status is Won] ')
            else:
                st.write('## :red[The status is Lost] ')
                
st.write( f'<h6 style="color:rgb(159, 43, 104,0.35);">App Created by Prathiksha</h6>', unsafe_allow_html=True )